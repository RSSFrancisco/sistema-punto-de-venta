    ...
    public class ReportePrincipal
    {
        ...
        public void GenerandoReporte(List<Requisicion> misRequisiciones, string nombre)
        {
            try
            {
                ...
                gfx.DrawString("Telefono: 271-112-25-29", letra3, XBrushes.Black, new XPoint(350, 150));
                ...
                foreach (Requisicion r in misRequisiciones)
                {
                    ...
                    if (misRequisiciones.Count > 0)
                    {
                        ...
                        #endregion
                        #region segundo recuadro con informacion de la empresa
                        //gfx.DrawString("RG SOLUCIONES CIBERNETICAS S.A DE C.V", letra, XBrushes.Black, new XPoint(335, 130));
                        //gfx.DrawString("Calle 5 N° 304, Col. Centro, Córdoba, Ver.", letra3, XBrushes.Black, new XPoint(350, 140));
                        //gfx.DrawString("Tel: (271) 7127342, FAX: (271) 7148421", letra3, XBrushes.Black, new XPoint(350, 150));
                        //gfx.DrawString("Email: soporte@rgsoluciones.com.mx", letra3, XBrushes.Black, new XPoint(353, 160));
