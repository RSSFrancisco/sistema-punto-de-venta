   ...
   public class ReporteEmpleado
    {
       ...
       public void Generando(List<Empleado> misEmpleados,string nombre)
       {
           try
           {
               ...
               foreach (Empleado d in misEmpleados)
               {
                      ...
                      
                   {
                           ...
                           int y2 = 135;
                           XImage image2 = XImage.FromFile(Environment.CurrentDirectory + @"\Empleados.png");
                           ...
                           gfx.DrawString("Nombre", letra2, XBrushes.Black, new XPoint(50, y2));
                           gfx.DrawString("Apellido Paterno", letra2, XBrushes.Black, new XPoint(160, y2));
                           gfx.DrawString("Apellido Materno", letra2, XBrushes.Black, new XPoint(290, y2));
                           gfx.DrawString("NSS", letra2, XBrushes.Black, new XPoint(420, y2));

                           y2 += 25;


                           pagina2.Orientation = PageOrientation.Portrait;
